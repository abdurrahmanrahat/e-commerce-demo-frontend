...
import { deleteCouponFromDB } from "@/app/actions/coupon";
...
export default function DeleteCouponModal({ couponId }: { couponId: string }) {
  ...
  const handleDeleteCoupon = async () => {
    ...
    try {
      const res = await deleteCouponFromDB(couponId);
